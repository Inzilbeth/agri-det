...
python mmdetection/tools/train.py configs/rtmdet-s_sahi_640.py
python mmdetection/tools/train.py configs/rtmdet-s_sahi_640_aug.py

python mmdetection/tools/train.py configs/rtmdet-tiny_sahi_1088.py
