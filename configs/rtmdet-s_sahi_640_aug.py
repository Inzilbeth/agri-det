...
data_root = 'data/sunflower_dataset_v1.0_sliced_640'
...
test_evaluator = dict(
    ann_file='data/sunflower_dataset_v1.0_sliced_640/val/val-annotations.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    proposal_nums=(
...
work_dir = './training-output/rtmdet-s_sahi_640_aug'
