...
test_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='test/test-annotations.json',
        backend_args=None,
...
test_evaluator = dict(
    ann_file=
    'data/sunflower_dataset_v1.0_sliced_1088/test/test-annotations.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    proposal_nums=(
...
work_dir = './training-output/rtmdet-tiny_sahi_1088_aug_finetune'
